...
public class OrderDTO {
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, memberEmail, memberId, memberName, orderCount, productId, productName, productPrice,
				productStock, totalPrice);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(id, other.id) && Objects.equals(memberEmail, other.memberEmail)
				...
				&& Objects.equals(productStock, other.productStock) && Objects.equals(totalPrice, other.totalPrice);
	}
